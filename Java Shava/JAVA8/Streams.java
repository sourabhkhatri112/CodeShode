 ...
 *         Streams -> Performing bulk operations over Collections
 */
...
class Employee{
	...
	void EmployeeOperations() {
		...
		/*
		 * skip(3) - Skip first 3 elements of stream
		 * limit(3) - Prints ONLY first 3 elements of stream
		 * OUTPUT - skip(3) : Rohan Raj
		 * LIMIT - limit(3) : Rakesh Sourabh Rajesh
		 * */
		 ...
		 * How ? 
		 * Step-1 : Sort by descending first
		 * Step-2 : skip(1) here used to skip the top employee
		 * Step-3 : findFirst() gets 1st element from remaining list
		 * findAny() return any element without specific order
		 * 
		 * OUTPUT : 90000
		 * */
		...
		/*
		 * Find average salary of employee above the age of 30
		 * average() - mapToint() is a mandatory function for perform average
		 * 
		 * OUTPUT : 60000.0
		 * */
		...
		/*
		 * Both operations below are able to find the SUM of all salaries
		 * sum(), average(), max() or min() must require mapToInt
		 * reduce() -> 0 here means values getting added to zero consecutively
		 * 
...
public class Streams {
	...
	void filter(List<String> fruits) {
		 ...
		 * 
		 * startsWith() -> used inside filter() 
		 * 				-> picks up array elements starting with prefix "a"
		 *
		...
		/* LIST : "apple", "banana", "apricot", "orange", "apple pie"
		 * 
		 * contains() -> used inside filter()
		 * 			  -> picks elements contains some prefix
		 * 
		 * Output: banana
		 * */
	 ...
	 * MAP is applied to each element independently.
	 * 
	 * */
	void map(List<String> fruits) {
		/* LIST : "apple", "banana", "apricot", "orange", "apple pie"
		 * 
		 * toUpperCase() -> used inside map()
		...
		/* LIST : "apple", "banana", "apricot", "orange", "apple pie"
		 * 
		 * i.substring(0,1) -> Begin_Index : 0 / End_Index : 1
		 * i.substring(1) -> Begin_Index : 1 / End_Index : End of String
		 * 
		 * Output : Apple Banana Apricot Orange Apple pie
		 * */
		...
		/*
		 * LIST : "1", "2", "3", "4", "5"
		 * i -> Integer.valueOf(i) -> Converting each String element in List to Integer
		 * 
		 * Output : 1 2 3 4 5
		 * */
		 ...
		 * 					
		 * 					-> FOR EG. When Fruits are empty :- fruits = Arrays.asList(); 
		 * 					-> Then, orElse(0) will run and print 0
		 * 
	...
	void ComparatorOperations() {
		/* LIST : "apple", "banana", "apricot", "orange", "apple pie"
		 *
		 * sorted() -> sorted either naturally or based on comparator based
		 * Output : apple apple_pie apricot banana orange 	// Sorted naturally
		 * */
		 ...
		 *
		 * sorted() -> sorted either naturally or based on comparator based
		 * Output : apple, banana, orange, apricot, apple_pie 	// Sorted comparator(length) based
		 * */
		 ...
		 * 	
		 * sorted() -> 1st sorting - length wise. If length is equal then 
		 * 			   2nd sorting - done alphabetically
		 * 
